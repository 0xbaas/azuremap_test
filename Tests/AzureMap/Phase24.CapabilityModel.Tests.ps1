#==============================================================================
# AzureMap v2 - Tests/AzureMap/Phase24.CapabilityModel.Tests.ps1
...
BeforeAll {
    ...
    . "$projectRoot\Products\AzureMap\Capability\CapabilityModel.Azure.ps1"
...
Describe "Phase B2 capability model" {
    ...
    Context "safety contract (static analysis of Core/Capability.ps1 + Core/Azure/CapabilityModel.Azure.ps1)" {
        BeforeEach {
            $script:CapModelSrc = (Get-Content -Raw (Join-Path $projectRoot 'Shared\Core\Capability.ps1')) + "`n" +
                                  (Get-Content -Raw (Join-Path $projectRoot 'Products\AzureMap\Capability\CapabilityModel.Azure.ps1'))
        }
